...
namespace Qase.Client.Model
{
    ...
    /// ConfigurationGroup
    /// </summary>
    [DataContract(Name = "ConfigurationGroup")]
    public partial class ConfigurationGroup
    {
        ...
        public ConfigurationGroup(long id = default(long), string title = default(string), List<ModelConfiguration> configurations = default(List<ModelConfiguration>))
        {
            this.Id = id;
            this.Title = title;
