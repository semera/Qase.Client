...
namespace Qase.Client.Model
{
    ...
    public partial class RunListResponse
    {
        ...
        public RunListResponse(bool status = default(bool), RunListResponseAllOfResult result = default(RunListResponseAllOfResult))
        {
            this.Status = status;
            this.Result = result;
        }
        ...
        public RunListResponseAllOfResult Result { get; set; }
