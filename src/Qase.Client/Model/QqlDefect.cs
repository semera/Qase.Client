...
namespace Qase.Client.Model
{
    ...
    /// QqlDefect
    /// </summary>
    [DataContract(Name = "qql.Defect")]
    public partial class QqlDefect
    {
        /// <summary>
        ...
        public QqlDefect(long id = default(long), string title = default(string), string actualResult = default(string), string severity = default(string), string status = default(string), long? milestoneId = default(long?), List<CustomFieldValue> customFields = default(List<CustomFieldValue>), List<Attachment> attachments = default(List<Attachment>), DateTime? resolved = default(DateTime?), long memberId = default(long), long authorId = default(long), string externalData = default(string), List<TagValue> tags = default(List<TagValue>), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            this.Id = id;
            this.Title = title;
