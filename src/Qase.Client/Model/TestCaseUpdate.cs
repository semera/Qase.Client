...
namespace Qase.Client.Model
{
    ...
    /// TestCaseUpdate
    /// </summary>
    [DataContract(Name = "TestCaseUpdate")]
    public partial class TestCaseUpdate
    {
        /// <summary>
        ...
        public TestCaseUpdate(string description = default(string), string preconditions = default(string), string postconditions = default(string), string title = default(string), int severity = default(int), int priority = default(int), int behavior = default(int), int type = default(int), int layer = default(int), int isFlaky = default(int), long suiteId = default(long), long milestoneId = default(long), int automation = default(int), int status = default(int), List<string> attachments = default(List<string>), List<TestStepCreate> steps = default(List<TestStepCreate>), List<string> tags = default(List<string>), Dictionary<string, List<string>> varParams = default(Dictionary<string, List<string>>), Dictionary<string, string> customField = default(Dictionary<string, string>))
        {
