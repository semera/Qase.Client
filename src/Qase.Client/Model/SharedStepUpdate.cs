...
namespace Qase.Client.Model
{
    ...
    /// SharedStepUpdate
    /// </summary>
    [DataContract(Name = "SharedStepUpdate")]
    public partial class SharedStepUpdate
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SharedStepUpdate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SharedStepUpdate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SharedStepUpdate" /> class.
        /// </summary>
        ...
        public SharedStepUpdate(string title = default(string), string action = default(string), string expectedResult = default(string), string data = default(string), List<SharedStepContentCreate> steps = default(List<SharedStepContentCreate>))
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for SharedStepUpdate and cannot be null");
            }
            this.Title = title;
            this.Action = action;
