...
namespace Qase.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PlanListResponse_allOf_result")]
    public partial class PlanListResponseAllOfResult
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlanListResponseAllOfResult" /> class.
        /// </summary>
        /// <param name="total">total.</param>
        /// <param name="filtered">filtered.</param>
        /// <param name="count">count.</param>
        /// <param name="entities">entities.</param>
        public PlanListResponseAllOfResult(int total = default(int), int filtered = default(int), int count = default(int), List<Plan> entities = default(List<Plan>))
        {
            this.Total = total;
